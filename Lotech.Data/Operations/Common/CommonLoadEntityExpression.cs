...
namespace Lotech.Data.Operations.Common
{
    ...
    public class CommonLoadEntityExpression<TEntity> : IOperationProvider<Func<IDatabase, Expression<Func<TEntity, bool>>, TEntity>>
        where TEntity : class
    {
        ...
        /// 
        /// </summary>
        protected CommonLoadEntityExpression(Func<IDatabase, SqlExpressionVisitor<TEntity>> visitorProvider)
        {
        ...
        public CommonLoadEntityExpression(Func<IDatabase, SqlExpressionVisitor<TEntity>> visitorProvider, Func<string, string> quote) : this(visitorProvider)
        {
            this.quote = quote;
        }

        Func<IDatabase, Expression<Func<TEntity, bool>>, TEntity>
            IOperationProvider<Func<IDatabase, Expression<Func<TEntity, bool>>, TEntity>>.Create(IEntityDescriptor descriptor)
        {
            if (quote != null)
            {
