...
namespace Lotech.Data.SqlServers
{
    class SqlServerEntityServices : IEntityServices
    {
        ...
        {
            return Operation<EntityType, Func<IDatabase, Expression<Func<EntityType, bool>>, int>, SqlServerCountEntitiesExpression<EntityType>>.Instance(Database.DescriptorProvider);
        }

        public Func<IDatabase, int> Count<EntityType>() where EntityType : class
        {
            return Operation<EntityType, Func<IDatabase, int>, SqlServerCountEntities<EntityType>>.Instance(Database.DescriptorProvider);
        }
        ...
        {
            return Operation<TEntity, Action<IDatabase, Expression<Func<TEntity, bool>>>, SqlServerDeleteEntitiesExpression<TEntity>>.Instance(Database.DescriptorProvider);
        }
        ...
        {
            return Operation<TEntity, Action<IDatabase, TKey>, SqlServerDeleteEntity<TEntity, TKey>>.Instance(Database.DescriptorProvider);
        }

        public Func<IDatabase, TEntity, bool> Exists<TEntity>() where TEntity : class
        {
            return Operation<TEntity, Func<IDatabase, TEntity, bool>, SqlServerExistsEntity<TEntity>>.Instance(Database.DescriptorProvider);
        }

        public Func<IDatabase, TKey, bool> ExistsByKey<TEntity, TKey>() where TEntity : class
        {
            return Operation<TEntity, Func<IDatabase, TKey, bool>, SqlServerExistsEntity<TEntity, TKey>>.Instance(Database.DescriptorProvider);
        }

        public Func<IDatabase, Expression<Func<TEntity, bool>>, bool> ExistsByPredicate<TEntity>() where TEntity : class
        {
            return Operation<TEntity, Func<IDatabase, Expression<Func<TEntity, bool>>, bool>, SqlServerExistsEntityExpression<TEntity>>.Instance(Database.DescriptorProvider);
        }

        public Func<IDatabase, TEntity[]> FindEntities<TEntity>() where TEntity : class
        {
            return Operation<TEntity, Func<IDatabase, TEntity[]>, SqlServerFindEntities<TEntity>>.Instance(Database.DescriptorProvider);
        }

        public Func<IDatabase, Expression<Func<TEntity, bool>>, TEntity[]> FindEntitiesByPredicate<TEntity>() where TEntity : class
        {
            return Operation<TEntity, Func<IDatabase, Expression<Func<TEntity, bool>>, TEntity[]>, SqlServerFindEntitiesExpression<TEntity>>.Instance(Database.DescriptorProvider);
        }
        ...
        {
            return Operation<TEntity, Func<IDatabase, TEntity, TEntity>, SqlServerLoadEntity<TEntity>>.Instance(Database.DescriptorProvider);
        }

        public Func<IDatabase, TKey, TEntity> LoadEntityByKey<TEntity, TKey>() where TEntity : class
        {
            return Operation<TEntity, Func<IDatabase, TKey, TEntity>, SqlServerLoadEntity<TEntity, TKey>>.Instance(Database.DescriptorProvider);
        }

        public Func<IDatabase, Expression<Func<TEntity, bool>>, TEntity> LoadEntityByPredicate<TEntity>() where TEntity : class
        {
            return Operation<TEntity, Func<IDatabase, Expression<Func<TEntity, bool>>, TEntity>, SqlServerLoadEntityExpression<TEntity>>.Instance(Database.DescriptorProvider);
        }
            ...
            where TSet : class
        {
            return Operation<EntityType, Action<IDatabase, EntityType, Expression<Func<EntityType, bool>>>,
                    SqlServerUpdateEntities<EntityType, TSet>>.Instance(Database.DescriptorProvider);
        }
    }
}
